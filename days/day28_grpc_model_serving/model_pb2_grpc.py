...
class ModelServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/modelserving.ModelService/Predict',
        ...
        self.Health = channel.unary_unary(
                '/modelserving.ModelService/Health',
...
def add_ModelServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'modelserving.ModelService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('modelserving.ModelService', rpc_method_handlers)
